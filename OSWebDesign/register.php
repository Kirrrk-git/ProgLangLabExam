...
<head>
    ...
    <title>Sign up - OS Web Design</title>
...
<body>
    ...
    <!-- Back Button -->
    <button class="back-button" onclick="window.location.href='login.php'" title="Go to Login">
            ...
            <form id="registerForm" method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        required
                    >
                    <p class="password-requirements">At least 8 characters with letters and numbers</p>
                </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
        ...
        if (empty($errors)) {
            // For demo purposes - in production, save to database
            echo '<script>
                document.addEventListener("DOMContentLoaded", function() {
                    document.querySelector(".signup-modal").innerHTML = \'<div class="success-message" style="padding: 30px; font-size: 18px;">Registration Successful! Welcome, ' . htmlspecialchars($fullname) . '!</div><p style="text-align: center; margin-top: 20px;"><a href="login.php">Go to Login</a></p>\';
                });
            </script>';
        }
    }
